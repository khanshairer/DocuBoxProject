...
class AppTheme {
  ...
  // Changed from `static final ThemeData lightTheme` to a static method
  static ThemeData lightTheme({
    ...
    final baseBrightness = Brightness.light; // Explicitly for light theme

    return ThemeData(
      brightness: baseBrightness, // Ensure explicit light brightness
      ...
      appBarTheme: AppBarTheme(
        ...
        titleTextStyle: GoogleFonts.montserrat(
          ...
          fontSize: 20 * fontSizeFactor, // Apply font size scaling here
      ...
      elevatedButtonTheme: ElevatedButtonThemeData(
        style: ElevatedButton.styleFrom(
          ...
          textStyle: GoogleFonts.montserrat(
            ...
            fontSize: 18 * fontSizeFactor, // Apply font size scaling here
          ),
      ...
      outlinedButtonTheme: OutlinedButtonThemeData(
        style: OutlinedButton.styleFrom(
          foregroundColor: kAccentAmber400, // Text color: amber[400]
          textStyle: GoogleFonts.montserrat(
            // Changed to GoogleFonts.montserrat for consistency
            fontWeight: FontWeight.bold, // Text style: bold
            fontSize: 16 * fontSizeFactor, // Apply font size scaling here
          ),
          padding: const EdgeInsets.symmetric(
            vertical: 14.0,
            horizontal: 20.0,
      ...
      sliderTheme: SliderThemeData(
        thumbColor: kAccentAmber400, // Amber thumb
        activeTrackColor: kPrimaryBlue900, // Active track (filled part)
        inactiveTrackColor: kPrimaryBlue900.withOpacity(
          0.3,
        ), // Inactive track (unfilled part)
        overlayColor: kAccentAmber400.withOpacity(0.2), // Overlay when pressed
      ),

      // --- Global Text Theme Scaling ---
      textTheme: GoogleFonts.latoTextTheme(
        // Apply Lato as the default font for the entire text theme
        ThemeData(
          brightness: baseBrightness,
        ).textTheme, // Base on Flutter's default light text theme
      ).apply(
        fontSizeFactor:
            fontSizeFactor, // Apply font size scaling to the whole TextTheme
        // bodyColor: Colors.black, // Explicitly set if not deriving correctly from baseBrightness
